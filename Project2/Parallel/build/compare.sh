...
#PBS -l select=3:ncpus=32:mpiprocs=16:ompthreads=16
...
echo "Hybrid vs MPI Only Performance" >> Compare
echo "Hybrid Performance"
...
echo "Shared Memory Performance"
mpiexec_mpt -n 3 omplace -nt 1 ./poisson 16384 >> Compare
mpiexec_mpt -n 6 omplace -nt 1 ./poisson 16384 >> Compare
mpiexec_mpt -n 9 omplace -nt 1 ./poisson 16384 >> Compare
mpiexec_mpt -n 12 omplace -nt 1 ./poisson 16384 >> Compare
mpiexec_mpt -n 18 omplace -nt 1 ./poisson 16384 >> Compare
